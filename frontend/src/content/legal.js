...
offers beta features, currently an AI wellness companion (chat), a
private journal, and Practice, a set of flashcards about mental health
concepts
(the "Experiments"). The Site and the Experiments together
are the "Service".
...
**Practice cards (Experiments, beta).** The cards themselves are public
files, the same as our guides, and reading them tells us nothing about you.
Which concepts you have met and which cards you want to come back to are
kept in your browser and are never sent to us. We do not record what you
answered, anywhere, and there is no score.

If you mark a card helpful or wrong, we store one number against that card
and nothing else. There is no account, no name and no identifier attached to
it, so we can see that nine people found a card wrong and we cannot see who
they were. That also means there is nothing of yours in it to include in an
export or to delete.

The cards are generated by AI and read by a person before they
are published. The Practice page says so, and they can still be wrong.
...
time you were last active (for the automatic sign-out), a flag recording
that you acknowledged the notice before your first chat, and your Practice
progress (which concepts you have met and which cards you marked). These live in your
